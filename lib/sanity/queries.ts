...
export const FALLBACK_TEAM: TeamMember[] = [
  {
    ...
    bio: 'Founded DICKALO in 2011 after eight years on large commercial sites in Lagos, Abuja and London. Still reviews every set of drawings before they leave the studio.',
  ...
  },
  {
    ...
    bio: 'Runs everything that happens after ground-breaking. Fourteen years of site management across seven states, and the reason the handover dates hold.',
  ...
  },
  {
    ...
    name: 'Segun Adeyemi',
    role: 'Head of Design',
    bio: 'Leads concept and design development. Spent five years in Rotterdam before coming home, and brought the detailing habits with him.',
  ...
  },
  {
    ...
    bio: 'Specifies and sources every finish we install. If a material cannot be replaced anywhere in Nigeria in under two weeks, she will not put it in your building.',
